export const ADVERSARY_BENCHMARKS = {
    "bruiser": {
      "tiers": {
        ...
        "tier_2": { "difficulty": "14–16", "threshold_min": "10/24", "threshold_max": "15/28", "hp": "5–7", "stress": "4–6", "attack_modifier": "+2 to +4", "damage_rolls": ["2d8+6", "2d10+4", "2d12+2"], "avg_damage": "12–16", "suggested_features": ["Momentum", "Ramp Up"] },
        "tier_3": { "difficulty": "16–18", "threshold_min": "18/35", "threshold_max": "25/40", "hp": "6–8", "stress": "4–6", "attack_modifier": "+3 to +5", "damage_rolls": ["3d8+6", "3d10+4", "3d12+2"], "avg_damage": "18–22", "suggested_features": ["Momentum", "Ramp Up"] },
    ...
    "horde": {
      "tiers": {
        ...
        "tier_2": { "difficulty": "12–14", "threshold_min": "10/16", "threshold_max": "15/20", "hp": "5–6", "stress": "2–3", "attack_modifier": "-1 to +1", "damage_rolls": ["2d6+6", "2d8+4", "2d10+2"], "halved_damage_x": ["2d4+1", "1d6+3"], "suggested_features": "" },
    ...
    "leader": {
      "tiers": {
        ...
        "tier_3": { "difficulty": "17–19", "threshold_min": "18/36", "threshold_max": "25/42", "hp": "6–8", "stress": "5–6", "attack_modifier": "+5 to +7", "damage_rolls": ["3d8+8", "3d10+4", "3d12+1"], "suggested_features": ["Momentum", "Move as a Unit", "Rally", "Reinforcements", "Tactician"] },
    ...
    "standard": {
      "tiers": {
        "tier_1": { "difficulty": "11–13", "threshold_min": "5/8", "threshold_max": "8/12", "hp": "3–4", "stress": "3–4", "attack_modifier": "+0 to +2", "damage_rolls": ["1d4+3", "1d6+2", "1d8+1"], "suggested_features": "" },
        ...
        "tier_3": { "difficulty": "15–17", "threshold_min": "15/27", "threshold_max": "20/32", "hp": "4–6", "stress": "5–6", "attack_modifier": "+2 to +4", "damage_rolls": ["3d6+3", "3d8+2", "3d10+1"], "suggested_features": "" },
        "tier_4": { "difficulty": "17–19", "threshold_min": "25/35", "threshold_max": "35/50", "hp": "5–6", "stress": "5–6", "attack_modifier": "+3 to +5", "damage_rolls": ["4d6+10", "4d8+6", "4d10+2"], "suggested_features": "" }
      }
    },
    "support": {
      "tiers": {
